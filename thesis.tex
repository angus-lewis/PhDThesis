...
\newcommand{\rapphase}{\phi}%{^{\mbox{\tiny T}}}
\newcommand{\hSigma}{\widehat{\Sigma}}%{^{\mbox{\tiny T}}}
\newcommand{\hGamma}{\widehat{\Gamma}}%{^{\mbox{\tiny T}}}

% widecheck command compatible with amsmath
...
\include{appendix_properties_of_B/appendix} 
