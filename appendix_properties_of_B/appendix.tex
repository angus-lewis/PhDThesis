\section{Properties of the DG operator \(\bs B\)}\label{sec:properties}
...
\end{proof}
%\begin{remark}
%	For any choice of basis \(\{\phi^r_k(x)\}_{r\in\{1,...,N_k\},k\in\{1,...,K\}}\) which spans the set of polynomials of degree \(N_k-1\), the DG approximation constructed with this basis will conserve probability. 
%\end{remark}
