...
\begin{align*}
 ...
 %
 \\ {  {\mathfrak{\bs B}}}^{0{-1}} &=-\left[c_i\widecheck p_{ij} 1{(c_i<0)}\right]_{i\in\calS,j\in\calS_{{-1}}}\otimes \bs P_0^{-1}\boldsymbol \phi_0(0)\tr{},
 %
 \\ {  {\mathfrak{\bs B}}}^{{K+1} K} &= \bs T_{{K+1}-}\otimes \left(\boldsymbol\phi_K(b)\bs M_K^{-1}\bs P_K\right)
 %
 \\ {  {\mathfrak{\bs B}}}^{K {K+1}} &= \left[c_i\widehat p_{ij}  1{(c_i>0)}\right]_{i\in\calS,j\in\calS_{K+1}} \otimes  \bs P_K^{-1} \boldsymbol\phi_K(b)\tr{},
 %
...
T_{ij}\bs I_{p_0} - c_i\widecheck p_{ij} 1(c_i<0)\bs F_i^{00}\bs M_0^{-1}\bs P_0 & i \neq j,
\end{cases}
%
\\\mathfrak{\bs B}^{KK}_{ij} &= \begin{cases}
	T_{ii}\bs I_{p_K} + c_i\bs P_K^{-1}(\bs F_i^{KK}+\bs G_K)\bs M_K^{-1}\bs P_K & i = j, \\
T_{ij}\bs I_{p_K} + c_i\widehat p_{ij} 1(c_i>0)\bs P_K^{-1}\bs F_i^{KK}\bs M_K^{-1}\bs P_K & i \neq j,
\end{cases}
%
...
\begin{proof}
	...
	\begin{align*}
		...
		\\&= \sum_{j\in\calS}T_{ij}\bs I_{p_K}\bs 1-\sum_{j\in\calS_-} c_i\widehat p_{ij}  \bs P_K^{-1}\bs F_i^{KK}\bs M_K^{-1}\bs P_K \bs 1 -\sum_{j\in\calS_{{K+1} }}c_i\widehat p_{ij} \bs P_K^{-1}\boldsymbol \phi_K(0)\tr{}\bs 1 
		\\&\quad{} + c_i \bs P_K^{-1}(\bs F_i^{KK}+\bs G_K)\bs M_K^{-1}\bs P_K\boldsymbol 1 
		\\&= -\sum_{j\in\calS_-} c_i\widehat p_{ij} \bs P_K^{-1}\bs F_i^{KK}\bs M_K^{-1}\bs P_K \bs 1 
		\\&{}\quad-\sum_{j\in\calS_{{K+1}}}c_i\widehat p_{ij} \bs P_K^{-1}\bs F_i^{KK}\bs M_K^{-1}\bs P_K\bs 1+ c_i \bs P_K^{-1}\bs F_i^{KK}\bs M_K^{-1}\bs P_K\boldsymbol 1
	...
	\begin{align*}
		...
		&= \sum_{j\in\calS}T_{ij}\bs I_{p_0}\bs 1-\sum_{j\in\calS_+} c_i\widecheck p_{ij} \bs P_0^{-1}\bs F_i^{00}\bs M_0^{-1}\bs P_0 \bs 1 -\sum_{j\in\calS_{{-1} }}c_i\widecheck p_{ij} \bs P_0^{-1}\boldsymbol \phi_0(0)\tr{}\bs 1 
