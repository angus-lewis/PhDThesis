...
%	\begin{align}
%		&\int_{t=0}^\infty e^{-\lambda t}\mathbb E[f(\bar X(t))1(\rapphase^{(p)}(t)=j, L(t)=\ell_0, L(s)=\ell_0, \rapphase^{(p)}(s)\in\calS_+\cup\calS_{+0},s\in[0,t])\mid L(0)=\ell_0, \nonumber
%		\\&\qquad{} \bs A(0)=\bs a_{\ell_0,i}(x_0), \rapphase^{(p)}(0)=i]\wrt t \nonumber
%		\\&= \int_{t=0}^\infty e^{-\lambda t}\mathbb E[\psi(X(t))1(\rapphase^{(p)}(t)=j,X(s)\in\calD_{\ell_0}, \rapphase^{(p)}(s)\in\calS_+\cup\calS_{+0},s\in[0,t])\mid X(0)=x_0, \rapphase^{(p)}(0)=i]\wrt t \nonumber
%		\\&\qquad {} + r_{11}^{(p)}
%	\end{align}
%	where 
...
%	\begin{align}
%		&\int_{t=0}^\infty e^{-\lambda t}\mathbb P(\bar X^{(p)}(t) \in \cdot, \rapphase^{(p)}(s)\in\mathcal S_-\cup\mathcal S_{-0}, s\in[0,t], \rapphase^{(p)}(t)=j\mid \bs A^{(p)}(0)=\bs k^{(p)}(x_0)\bs D^{(p)}, \rapphase^{(p)}(0)=i) \wrt t \nonumber 
%		%
%		\\& \to \int_{t=0}^\infty e^{-\lambda t}\mathbb P( X(t) \in \cdot, \rapphase^{(p)}(s)\in\mathcal S_-\cup\mathcal S_{-0}, s\in[0,t], \rapphase^{(p)}(t)=j\mid X(0)= x_0, \rapphase^{(p)}(0)=i) \wrt t \label{eqn: ffaA}
%	\end{align}
%	as \(p\to\infty\).
%\end{cor}
%\begin{proof}
...
%	\begin{align}
%		&  \mathbb E[f(\bar X^{(p)}(t))1(\rapphase^{(p)}(s)\in\mathcal S_-\cup\mathcal S_{-0}, s\in[0,t], \rapphase^{(p)}(t)=j) \mid \bs A^{(p)}(0)=\bs k^{(p)}(x_0)\bs D^{(p)}, \rapphase^{(p)}(0)=i]  \nonumber 
%		\\& \to \mathbb E[\psi(X(t)) 1(\rapphase^{(p)}(s)\in\mathcal S_-\cup\mathcal S_{-0}, s\in[0,t], \rapphase^{(p)}(t)=j) \mid X(0)=x_0, \rapphase^{(p)}(0)=i],
%	\end{align}
%	as \(p\to\infty\), for every bounded, Lipschitz function \(f\). By the Portmanteau Theorem, then 
%	\begin{align}
%		& \mathbb P(\bar X^{(p)}(t) \in \cdot, \rapphase^{(p)}(s)\in\mathcal S_-\cup\mathcal S_{-0}, s\in[0,t], \rapphase^{(p)}(t)=j\mid \bs A^{(p)}(0)=\bs k^{(p)}(x_0)\bs D^{(p)}, \rapphase^{(p)}(0)=i)   \nonumber 
%		%
%		\\& \to \mathbb P( X(t) \in \cdot, \rapphase^{(p)}(s)\in\mathcal S_-\cup\mathcal S_{-0}, s\in[0,t], \rapphase^{(p)}(t)=j\mid X(0)= x_0, \rapphase^{(p)}(0)=i) 
%	\end{align}
...
%		&\int_{t=0}^\infty e^{-\lambda t}\mathbb P(\bar X^{(p)}(t) \in \cdot, \rapphase^{(p)}(s)\in\mathcal S_-\cup\mathcal S_{-0}, s\in[0,t], \rapphase^{(p)}(t)=j\mid \bs A^{(p)}(0)=\bs k^{(p)}(x_0)\bs D^{(p)}, \rapphase^{(p)}(0)=i) \wrt t \nonumber 
%		%
%		\\& \to \int_{t=0}^\infty e^{-\lambda t}\mathbb P( X(t) \in \cdot, \rapphase^{(p)}(s)\in\mathcal S_-\cup\mathcal S_{-0}, s\in[0,t], \rapphase^{(p)}(t)=j\mid X(0)= x_0, \rapphase^{(p)}(0)=i) \wrt t
%	\end{align}
