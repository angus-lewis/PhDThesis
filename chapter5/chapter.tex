...
In this section we consider the embedded process formed by observing the QBD-RAP at changes of level. Now, let \(\{\tau_n^{(p)}\}_{n\geq 0, n \in \mathbb Z}\), \(\tau_0^{(p)}=0\), and
